...
<script>
	...
	import FieldCheckboxSkel from "./fieldCheckboxSkel.vue";
	Vue.component("field-checkboxSkel", FieldCheckboxSkel);

	import FieldRadioSkel from "./fieldRadioSkel.vue";
	Vue.component("field-radioSkel", FieldRadioSkel);
